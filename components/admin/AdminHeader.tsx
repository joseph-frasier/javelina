        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="relative" ref={notificationRef}>
              ...
              {isNotificationOpen && (
                <div className="absolute right-0 mt-2 w-80 sm:w-80 max-w-[calc(100vw-1rem)] bg-white dark:bg-gray-slate rounded-xl shadow-lg border border-gray-light overflow-hidden z-50 animate-in fade-in zoom-in-95 duration-100">
