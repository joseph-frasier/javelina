        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="relative" ref={notificationRef}>
              ...
              {isNotificationOpen && (
                <div className="absolute left-2 right-2 sm:left-auto sm:right-0 mt-2 sm:w-80 bg-white dark:bg-gray-slate rounded-xl shadow-lg border border-gray-light overflow-hidden z-50 animate-in fade-in zoom-in-95 duration-100">
