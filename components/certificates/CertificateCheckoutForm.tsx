    ...
    <div className="max-w-2xl mx-auto">
      <form onSubmit={handleSubmit}>
        <Card>
          ...
          {/* CSR */}
          <p className="text-xs font-medium uppercase tracking-[0.22em] text-orange mb-3">Certificate Signing Request (CSR)</p>
          <div className="mb-3">
                  ...
                  <div className="space-y-1">
                    ...
                    {csrResult.domain && (
                      <p className="text-green-600 dark:text-green-500">
                        Domain: <span className="font-mono">{csrResult.domain}</span>
                      </p>
                    )}
                    {csrResult.key_size && (
                      <p className="text-green-600 dark:text-green-500">
                        Key size: {csrResult.key_size}
                      </p>
                    )}
                    {csrResult.org_name && (
                      <p className="text-green-600 dark:text-green-500">
                        Organization: {csrResult.org_name}
                      </p>
                    )}
                  </div>
                ) : (
