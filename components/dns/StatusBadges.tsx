...
export function ZoneStatusBadge({ status, errorMessage, lastValidSerial, soaSerial }: ZoneStatusBadgeProps) {
  const styles = {
    ...
    ok: 'bg-green-100 text-green-800 border-green-200 dark:bg-green-900/30 dark:text-green-300 dark:border-green-700',
  };
  ...
  // For error status, show error message and last valid serial
    ...
    return (
      <div className="space-y-1">
        ...
        <div className="text-xs text-red-700 dark:text-red-300">
          ...
          {lastValidSerial !== undefined && (
            <div className="text-red-600 dark:text-red-400 mt-0.5">
              Last valid serial: {lastValidSerial}
            </div>
          )}
        </div>
      </div>
