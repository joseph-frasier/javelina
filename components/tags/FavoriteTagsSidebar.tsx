...
export function FavoriteTagsSidebar({
  ...
  if (isCollapsed) {
    // Collapsed view - just show a star icon
    return (
      <div className="px-2 py-1">
        <div 
          className="p-2 rounded-md flex items-center justify-center hover:bg-gray-light dark:hover:bg-gray-700 transition-colors cursor-pointer"
          title="Favorite Tags"
        >
