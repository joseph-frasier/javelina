  ...
  if (isCollapsed) {
    ...
    return (
      <div className="px-2 py-1">
        <div 
          className="p-2 rounded-md flex items-center justify-center hover:bg-surface-hover dark:hover:bg-gray-700 transition-colors cursor-pointer relative"
          title="Favorite Tags"
        >
      ...
      <div className="px-2">
        ...
        {hasActiveFilters && (
          <button
            ...
            className="w-full flex items-center gap-2 px-2 py-1.5 rounded-md text-sm text-text-muted hover:text-accent hover:bg-surface-hover/50 dark:hover:bg-gray-700 transition-colors mb-1"
          >
            ...
            return (
              <button
                ...
                className={`
                  ...
                  ${isActive 
                    ? 'bg-accent/10' 
                    : 'hover:bg-surface-hover/50 dark:hover:bg-gray-700'
                  }
                `}
              >
        ...
        {favoriteTags.length > 4 && (
          <p className="text-xs text-text-muted dark:text-gray-500 mt-2 px-2">
