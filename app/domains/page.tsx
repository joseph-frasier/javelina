  ...
  if (!hideSslCertificates && tab === 'ssl-certificates') {
    return (
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-text">SSL Certificates</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
            Purchase and manage SSL/TLS certificates for your domains.
          </p>
        </div>
        <div className="flex items-center justify-between">
          <Link href="/domains" className="text-sm text-accent hover:text-accent/70 transition-colors">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-bold text-text">Domains</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
            ...
            <Link
              ...
              className={`pb-3 text-sm font-medium transition-colors ${
                isActive
                  ...
                  : 'text-text-muted hover:text-gray-700 dark:hover:text-gray-100'
              }`}
            >
              {t.label}
            </Link>
